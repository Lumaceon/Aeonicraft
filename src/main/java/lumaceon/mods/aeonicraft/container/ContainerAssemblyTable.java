...
import lumaceon.mods.aeonicraft.inventory.InventoryUpdated;
import lumaceon.mods.aeonicraft.inventory.slot.SlotAssemblable;
...
public class ContainerAssemblyTable extends Container
{
    ...
    protected void setupNewContainerAndGUI(ItemStack item)
    {
        ...
        Slot[] slots = constructGUI.getContainerSlots(componentInventory, 142, 68);
        for(Slot slot : slots)
        {
