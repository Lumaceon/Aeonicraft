package lumaceon.mods.aeonicraft.block.multiblockplacers;
...
public class ItemAssemblyTable extends ItemAeonicraftMultiblockPlacer
{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if(player.canPlayerEdit(pos, facing, stack) && player.canPlayerEdit(blockpos, facing, stack))
        {
            ...
            if(flag2 && flag3)
            {
                IBlockState iblockstate1 = ModBlocks.assembly_table.getDefaultState().withProperty(CustomProperties.FACING_HORIZONTAL, enumfacing.getOpposite()).withProperty(BlockAssemblyTable.PART, BlockAssemblyTable.EnumPartType.LEFT);
